...
system("cp -R Evoker.jar evoker_$release/other/");
 ...
 for my $platform ('all','win','mac','other') {
	...
	system("cp resources/sample_* evoker_$release/$platform/");
	system("cp resources/sample.list evoker_$release/$platform/");
	system("cp resources/sample.qc evoker_$release/$platform/");
